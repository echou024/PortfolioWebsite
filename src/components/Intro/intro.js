  ...
  return (
    <section id='intro'>
        <div className='introContent' data-aos="fade-up">
            ...
            <p className='introPara' data-aos="fade-up">I am a Computer Science student passionate about utilizing advanced <br/> AI technologies to uncover insights and create impactful digital solutions.</p>
